...
#ifndef MHLTQ_NAMESPACE
#  define MHLTQ_NAMESPACE MHLTQ
#endif

#ifndef MHLTQ_LIB_HPP
#define MHLTQ_LIB_HPP
...
namespace MHLTQ_NAMESPACE
{
	...
	struct Compound
	{
        ...
        std::map<unsigned int, Spectrum> Spectra;
    ...
    void EncodeTarget(const TargetCompound& input, std::string& output);
    ...
    struct QuantitationDataSet
    {
        ...
        std::string DAMethodLastAppliedTimeStamp =
            "0001-01-01T00:00:00+00:00";
        std::string CalibrationLastUpdatedTimeStamp =
            "0001-01-01T00:00:00+00:00";
        std::string ReportGenerationStartedTimeStamp =
            "0001-01-01T00:00:00+00:00";
    ...
    std::string makeQuantMethodFromLibrary(
